...
exports.connectToDatabaseMongoose = connectToDatabaseMongoose;
...
function connectToDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const carparkCollection = db.collection(process.env.DB_COLLECTION_NAME);
        const availableCarParkCollection = db.collection(process.env.DB_COLLECTION_NAME_AVAILABILITY);
...
function connectToDatabaseMongoose() {
    return __awaiter(this, void 0, void 0, function* () {
