...
exports.CarParkAvailabilityModel = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const dotenv = __importStar(require("dotenv"));
dotenv.config();
const CarParkAvailabilitySchema = new mongoose_1.Schema({
...
exports.CarParkAvailabilityModel = mongoose_1.default.model(process.env.DB_COLLECTION_NAME_AVAILABILITY, CarParkAvailabilitySchema);
