...
const HDBCarparkInformationSchema_1 = require("../class/HDBCarparkInformationSchema");
...
function updateCarParkInformation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield HDBCarparkInformationSchema_1.HDBCarparkInformationSchema.deleteMany({});
        try {
            const carParkInfoResult = yield getCarParkInfo();
            if (!carParkInfoResult)
                throw new Error("Failed to fetch car park information");
            const [nextOffset, newTotal] = carParkInfoResult;
            let total = newTotal;
            let offset = nextOffset + 100;
            while (offset < total) {
                const carParkInfoResult = yield getCarParkInfo(offset);
                if (!carParkInfoResult)
                    throw new Error("Failed to fetch car park information");
                const [nextOffset] = carParkInfoResult;
...
function getCarParkInfo() {
    return __awaiter(this, arguments, void 0, function* (offset = 0) {
        ...
        try {
            ...
            yield HDBCarparkInformationSchema_1.HDBCarparkInformationSchema.insertMany(data.result.records.map((record) => {
                ...
                return new HDBCarparkInformationSchema_1.HDBCarparkInformationSchema({
